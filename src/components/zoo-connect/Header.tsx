...
function Header() {
  ...
  return (
    <div className='md:px-12 lg:px-24 xl:px-32 bg-background'>
      <p className='hidden md:block text-foreground text-2xl text-center py-12'>Fund Zoo Connect A Voice for Endangered Animals</p>
      <div className="bg-background max-md:pt-20 block md:grid grid-cols-2 gap-8 lg:gap-16 xl:gap-24 ">
          <div className='zoo-connect block'>
              <Slider {...settings} className='bg-background w-full'>
                  <Image
                      className='w-full'
          ...
          <div className="flex flex-col max-md:py-4 px-4 md:hidden">
            <p className='px-2 max-md:py-2 text-foreground text-2xl pb-4'>Fund Zoo Connect A Voice for Species Globally</p>
            <p className='px-2 text-foreground text-sm'><span className='text-[#3C9465]'>$6,679</span> fund raised from $8,200</p>
            ...
            <div className='flex items-center justify-between px-2 pt-6 text-foreground text-sm'>
              ...
              <div className='flex items-center space-x-1'>
                  <Image
                      ...
                      alt=''
                  />
                  <p className=' text-foreground text-sm'>3,438 donators</p>
            ...
            <Link href='/donation' className='bg-[#3C9465] text-center py-2 my-5 rounded-full w-full text-foreground text-xl'>Donate Now</Link>
            <hr />
          </div>
          <div className='md:flex flex-col text-foreground max-md:hidden justify-between'>
            ...
            <div className='flex pt-6 space-x-4 2xl:space-x-16'>
              <input onChange={handleInputChange} value={amount} className='w-1/2 outline-none bg-transparent text-foreground text-center px-4 py-1 md:text-sm lg:text-md xl:text-lg border border-white rounded-full' placeholder='Enter $' />
              <button onClick={handleSubmit} className='w-1/2 bg-white hover:bg-background hover:text-foreground border border-white px-4 py-1 rounded-full text-black font-medium md:text-sm transition-colors'>Donate</button>
            </div>
          </div>
      </div>
    </div>
