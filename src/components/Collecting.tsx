...
function Collecting() {
  return (
    <div className="bg-background lg:py-52 md:py-32 max-md:py-0">
        <div className='w-full text-center items-center flex flex-col justify-between'>
            <Link href='/animals'  className='text-foreground md:text-4xl xl:text-6xl max-md:text-3xl max-md:my-5 pb-8'>Start Collecting</Link>
            ...
            <div className='flex max-md:flex-col pt-8 items-center justify-center md:space-x-8 max-md:space-y-4'>
                <Link href="/animals"  className='flex items-center cursor-pointer text-foreground md:text-sm lg:text-md xl:text-xl max-md:pb-10' legacyBehavior>
                  <a>
                ...
                <Link href="https://app.zoolabs.io/"  className='flex items-center cursor-pointer text-foreground md:text-sm lg:text-md xl:text-lg max-md:pb-6' legacyBehavior>
                  <a>
