    ...
    <Layout>
        ...
        <div className='bg-background py-32 text-foreground'>
          <div className='md:w-[500px] mx-auto w-full rounded-3xl px-12 md:border border-white py-8 flex flex-col'>
            <p className='text-foreground text-2xl text-center pb-8'>Sign up for free</p>
            ...
            <div className='flex items-center justify-center space-x-2 mt-8'>
              <p className='text-foreground text-sm'>Already have an account?</p>
              <Link href='/signin' className='hover:text-foreground text-[#aaa] text-sm'>Sign In</Link>
            </div>
          </div>
        </div>
        <Footer />
