    ...
    <Layout>
        ...
        <div className='bg-background py-32 text-foreground'>
          <div className='md:w-[500px] mx-auto w-full rounded-3xl px-12 md:border border-white py-8 flex flex-col'>
            <p className='text-foreground text-2xl text-center pb-8'>Forgot Password</p>
            <p className='text-foreground text-md text-center'>Select which contact details should we use to reset your password</p>
          ...
          <div className='md:w-[500px] mx-auto w-full rounded-3xl px-12 md:border border-white py-8 flex flex-col'>
            <p className='text-foreground text-2xl text-center pb-8'>Forgot Password</p>
            <p className='text-foreground text-md text-center pb-8'>Code has been send to +6282******39</p>
            <div className='flex items-center justify-between'>
              <input className='w-[50px] bg-[#262934] h-[50px] text-center text-xl rounded-full outline-none  border border-[#262934] text-foreground' maxLength={1}/>
              <input className='w-[50px] bg-[#262934] h-[50px] text-center text-xl rounded-full outline-none  border border-[#262934] text-foreground' maxLength={1}/>
              <input className='w-[50px] bg-[#262934] h-[50px] text-center text-xl rounded-full outline-none  border border-[#262934] text-foreground' maxLength={1}/>
              <input className='w-[50px] bg-[#262934] h-[50px] text-center text-xl rounded-full outline-none  border border-[#262934] text-foreground' maxLength={1}/>
            </div>
