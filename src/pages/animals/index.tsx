...
export default function CollectPage() {
  return (
    <Layout>
        <Seo />
        <Navbar />
        <div className='pt-16 px-6 md:px-12 bg-background relative'>
          <div className='flex flex-col items-center justify-center relative'>
            <div className='relative z-10 mb-8'>
              <Globe />
            </div>
            <div className='text-center -mt-12 relative z-20'>
              <h1 className='text-foreground text-center text-4xl md:text-5xl lg:text-6xl mb-8'>Our Supported Animals</h1>
